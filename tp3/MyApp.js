...
class MyApp {
  ...
  init() {
    ...
    this.initCameras();
    // this.setActiveCamera("Parking Lot");
  ...
  initCameras() {
    ...
    const perspective3 = new THREE.PerspectiveCamera(45, aspect, 0.1, 1000);
    perspective3.position.set(17.1, 1, 17);
    perspective3.lookAt(14, 0, 17);
    this.cameras["Finish Camera"] = perspective3;
    ...
    const parkingLot = new THREE.PerspectiveCamera(45, aspect, 0.1, 1000);
    this.cameras["Parking Lot"] = parkingLot;

    // add camera to each car (top)
  ...
  updateCameraIfRequired() {
    ...
    if (this.lastCameraName !== this.activeCameraName) {
      ...
      if (this.controls === null) {
        ...
        this.controls.mouseButtons = { LEFT: THREE.MOUSE.LEFT, MIDDLE: THREE.MOUSE.MIDDLE };
