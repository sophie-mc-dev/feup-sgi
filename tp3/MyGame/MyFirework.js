...
class MyFirework {
    ...
    constructor(app, scene, originVert) {
        this.app = app
        this.scene = scene
        this.originVert = originVert
    ...
    launch() {
        ...
        this.geometry.setAttribute( 'position', new THREE.BufferAttribute( new Float32Array(this.originVert), 3 ) );
